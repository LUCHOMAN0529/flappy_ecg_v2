...
# Importamos la configuración centralizada de la forma correcta
import config as cfg

class SerialReader:
    def __init__(self):
        # Buffer circular para almacenar las muestras
    ...
    def connect(self):
        ...
        try:
            ...
            self.connected = False
            # No imprimimos el error completo si es solo que el Arduino no está conectado (para pruebas)
